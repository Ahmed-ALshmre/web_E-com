    ...
    return SafeArea(
      child: Scaffold(
        body: PageView(
          ...
          children: <Widget>[
            Container(
              child: HomePage1('https://925.is/'),
            ),
            Container(
              child: HomePage1('https://925.is/brand/whats_new'),
            ),
            Container(
              child: HomePage1('https://925.is/my-account/'),
            ),
          ],
        ),
        bottomNavigationBar: StreamBuilder<Object>(
            ...
            builder: (context, snapshot) {
              ...
              icon: Icon(Icons.home), title: Text('الصفحة الرئيسية',
                  ...
                  FancyBottomNavigationItem(
              icon: Icon(Icons.account_balance_wallet), title: Text('جديدنا',
                    style: new TextStyle(
                        fontWeight: FontWeight.bold,
                        fontFamily: ArabicFonts.Cairo,
                        package: 'google_fonts_arabic',
                  ...
                  FancyBottomNavigationItem(
                      icon: Icon(Icons.person), title: Text('حسابي',
                    style: new TextStyle(
                        fontWeight: FontWeight.bold,
                        fontFamily: ArabicFonts.Cairo,
                        package: 'google_fonts_arabic',
